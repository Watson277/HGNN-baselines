...
dataset = HGBDataset(root='/tmp/HGB', name='DBLP', transform=transform)
data = dataset[0]
...
if best_result is not None:
    ...
    print(f"Epoch: {best_epoch:03d}, Loss: {best_result['Loss']:.4f}, "
          ...
          f"Test Acc: {best_result['Test Acc']:.4f}, AUC: {best_result['Test AUC']:.4f}, "
          f"F1 Micro: {best_result['Test F1 Micro']:.4f}, F1 Macro: {best_result['Test F1 Macro']:.4f}")

log = (f"Epoch: {best_epoch:03d}, Loss: {best_result['Loss']:.4f}, "
          f"Train Acc: {best_result['Train Acc']:.4f}, "
          f"Test Acc: {best_result['Test Acc']:.4f}, "
          f"F1 Micro: {best_result['Test F1 Micro']:.4f}, F1 Macro: {best_result['Test F1 Macro']:.4f}, "
          f"AUC: {best_result['Test AUC']:.4f}")
